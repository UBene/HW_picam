...
PicamParameter = OrderedDict(
    [
        ...
        (
            ...
            PI_Param("FloatingPoint", "Collection", 47),
        ),
        ...
        (
            ...
            PI_Param("LargeInteger", "Range", 97),
        ),
        (
            "PicamParameter_SequentialGateStepIterations",
            PI_Param("LargeInteger", "Range", 98),
        ),
        ...
        (
            ...
            PI_Param("Enumeration", "Collection", 123),
        ),
        ...
        (
            ...
            PI_Param("FloatingPoint", "Collection", 90),
        ),
        ...
        (
            ...
            PI_Param("Boolean", "Collection", 116),
        ),
        (
            "PicamParameter_ModulationOutputSignalFrequency",
            PI_Param("FloatingPoint", "Range", 117),
        ),
        (
            "PicamParameter_ModulationOutputSignalAmplitude",
            PI_Param("FloatingPoint", "Range", 120),
        ),
        ...
        (
            ...
            PI_Param("Enumeration", "Collection", 26),
        ),
        (
            "PicamParameter_ReadoutTimeCalculation",
            PI_Param("FloatingPoint", "None", 27),
        ),
        ...
        (
            ...
            PI_Param("LargeInteger", "None", 77),
        ),
        (
            "PicamParameter_PhotonDetectionMode",
            PI_Param("Enumeration", "Collection", 125),
        ),
        (
            "PicamParameter_PhotonDetectionThreshold",
            PI_Param("FloatingPoint", "Range", 126),
        ),
        ...
        (
            ...
            PI_Param("FloatingPoint", "None", 50),
        ),
        (
            "PicamParameter_OnlineReadoutRateCalculation",
            PI_Param("FloatingPoint", "None", 99),
        ),
        ...
        (
            ...
            PI_Param("LargeInteger", "Collection", 69),
        ),
        ...
        (
            ...
            PI_Param("Enumeration", "Collection", 121),
        ),
        (
            "PicamParameter_ModulationTrackingBitDepth",
            PI_Param("Integer", "Collection", 122),
        ),
        # /*-------------------------------------------------------------------------------------*/
        # /* Sensor Information -----------------------------------------------------------------*/
        # /*-------------------------------------------------------------------------------------*/
        ...
        (
            ...
            PI_Param("Boolean", "Collection", 130),
        ),
        # /*-------------------------------------------------------------------------------------*/
        # /* Sensor Temperature -----------------------------------------------------------------*/
        # /*-------------------------------------------------------------------------------------*/
        (
            ...
            PI_Param("FloatingPoint", "Range", 14),
        ),
        (
            "PicamParameter_SensorTemperatureReading",
            PI_Param("FloatingPoint", "None", 15),
        ),
        ...
        (
            ...
            PI_Param("Boolean", "Collection", 127),
        ),
        ...
        (
            ...
            PI_Param("FloatingPoint", "Range", 140),
        ),
        (
            "PicamParameter_CenterWavelengthReading",
            PI_Param("FloatingPoint", "None", 141),
        ),
        ...
        (
            ...
            PI_Param("FloatingPoint", "None", 145),
        ),
...
PicamParameterEnum = PI_Enum(
    "PicamParameter", {name: param.enum for name, param in PicamParameter.items()}
)
...
class PicamRoi(ctypes.Structure):
    ...
    def __str__(self):
        return "PicamRoi: " + " ".join(
            [
                "{}->{}; ".format(fname, getattr(self, fname))
...
PicamAdcAnalogGainEnum = PI_Enum(
    "PicamAdcAnalogGain",
    dict(
        PicamAdcAnalogGain_Low=1, PicamAdcAnalogGain_Medium=2, PicamAdcAnalogGain_High=3
    ),
)
"""
/*----------------------------------------------------------------------------*/
...
PicamEMIccdGainControlModeEnum = PI_Enum(
    ...
    dict(PicamEMIccdGainControlMode_Optimal=1, PicamEMIccdGainControlMode_Manual=2),
)
"""
/*----------------------------------------------------------------------------*/
...
PicamGatingSpeedEnum = PI_Enum(
    "PicamGatingSpeed", dict(PicamGatingSpeed_Fast=1, PicamGatingSpeed_Slow=2)
)
"""
/*----------------------------------------------------------------------------*/
...
PicamIntensifierStatusEnum = PI_Enum(
    ...
    dict(PicamIntensifierStatus_PoweredOff=1, PicamIntensifierStatus_PoweredOn=2),
)
"""
/*----------------------------------------------------------------------------*/
...
PicamLightSourceStatusEnum = PI_Enum(
    ...
    dict(PicamLightSourceStatus_Unstable=1, PicamLightSourceStatus_Stable=2),
)
"""
/*----------------------------------------------------------------------------*/
...
PicamPhosphorTypeEnum = PI_Enum(
    "PicamPhosphorType", dict(PicamPhosphorType_P43=1, PicamPhosphorType_P46=2)
)
"""
/*----------------------------------------------------------------------------*/
...
PicamPixelFormatEnum = PI_Enum(
    "PicamPixelFormat",
    dict(PicamPixelFormat_Monochrome16Bit=1, PicamPixelFormat_Monochrome32Bit=2),
)
"""
/*----------------------------------------------------------------------------*/
...
PicamSensorTypeEnum = PI_Enum(
    "PicamSensorType",
    dict(PicamSensorType_Ccd=1, PicamSensorType_InGaAs=2, PicamSensorType_Cmos=3),
)
"""
/*----------------------------------------------------------------------------*/
...
PicamTriggerCouplingEnum = PI_Enum(
    "PicamTriggerCoupling", dict(PicamTriggerCoupling_AC=1, PicamTriggerCoupling_DC=2)
)
"""
/*----------------------------------------------------------------------------*/
...
PicamTriggerStatusEnum = PI_Enum(
    "PicamTriggerStatus",
    dict(PicamTriggerStatus_NotConnected=1, PicamTriggerStatus_Connected=2),
)
"""
/*----------------------------------------------------------------------------*/
...
PicamTriggerTerminationEnum = PI_Enum(
    ...
    dict(PicamTriggerTermination_FiftyOhms=1, PicamTriggerTermination_HighImpedance=2),
)
"""
...
PicamVacuumStatusEnum = PI_Enum(
    "PicamVacuumStatus", dict(PicamVacuumStatus_Sufficient=1, PicamVacuumStatus_Low=2)
)
"""
/*----------------------------------------------------------------------------*/
...
class PicamAcquisitionErrorsMask(ctypes.Structure):
    __fields__ = [
        ("PicamAcquisitionErrorsMask_None", ctypes.c_int(0x00)),
        ("PicamAcquisitionErrorsMask_CameraFaulted", ctypes.c_int(0x10)),
        ("PicamAcquisitionErrorsMask_ConnectionLost", ctypes.c_int(0x02)),
        ("PicamAcquisitionErrorsMask_ShutterOverheated", ctypes.c_int(0x08)),
        ("PicamAcquisitionErrorsMask_DataLost", ctypes.c_int(0x01)),
        ("PicamAcquisitionErrorsMask_DataNotArriving", ctypes.c_int(0x0)),
    ]
...
class PicamAcquisitionStatus(ctypes.Structure):
    _fields_ = [
        ...
        #("errors", PicamAcquisitionErrorsMaskEnum),  # THIS MIGHT BE WRONG
        ("readout_rate", piflt),
    ]
