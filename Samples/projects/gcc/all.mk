...
SOLUTION := all
#-------------------------------------------------------------------------------
SDK_PRJ := acquire acquisition_state advanced configure em_gain_calibration \
           gating kinetics metadata multicam param_info poll rois save_data \
           spectrograph wait_for_trig
################################################################################
